    ...
    public static BaseAgent createWorkflowAgent() {
        ...
        LlmAgent analysisAgent = LlmAgent.builder()
                ...
                .instruction(
                        ...
                        "  2. Evaluate the typical characteristics and challenges of companies at this stage in this industry.\n" +
                        "  3. Suggest 2–3 growth opportunities or strategic priorities based on the company's stage and revenue range.\n" +
                        "  4. Mention any common risks or red flags associated with similar startups.\n" +
                        "  5. Keep your tone professional, insightful, and concise.\n" +
                        "  6. Use the vector search tool to find similar companies for benchmarking."
                )
        ...
        LlmAgent benchmarkAgent = LlmAgent.builder()
                ...
                .instruction(
                        ...
                        "  2. Use the vector search tool to find the most similar companies.\n" +
                        "  3. Create a detailed benchmarking report including:\n" +
                        ...
                        "  5. Format the report in a clear, structured manner."
                )
                .tools(vectorSearchTool)
